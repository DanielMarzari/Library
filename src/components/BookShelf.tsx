      ...
      {sections.map((status) => {
        ...
        return (
          <section key={status}>
            ...
            {/* Responsive grid: 4 columns on small screens, scales up */}
            <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 gap-3 px-1">
              {sectionBooks.map((book) => (
                ...
                >
                  <div className="relative aspect-[2/3] rounded-md overflow-hidden shadow-lg shadow-black/40 transition-transform group-hover:scale-105 group-hover:-translate-y-1">
                    {book._optimistic ? (
